  ...
  return (
    <section className="h-screen relative top-8 flex justify-between align-middle">
      <div className="left-cont w-[65%] flex flex-col justify-center">
        <h2 className="text-[#A0988C] text-2xl md:text-5xl font-bold tracking-wide mb-2">
          Frontend Designer +
        </h2>
        ...
        <p className="text-[#A0988C] text-xl mt-10 tracking-wide">
      ...
      <div className="right-cont flex flex-col justify-center">
        <div className="rounded-full overflow-hidden border-4 border-gray-500">
          <Image
